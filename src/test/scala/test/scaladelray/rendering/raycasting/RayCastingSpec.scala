...
package test.scaladelray.rendering.raycasting
...
class RayCastingSpec extends FunSpec {

  describe( "The RayCasting algorithm" ) {
    ...
    it( "should have a function that calculates correct rays for a each pixel of an image out of a perspective camera" ) {
      ...
      val renderingAlgorithm = new RayCasting( Color( 0, 0, 0 ), World( SingleBackgroundColor( Color( 0, 0, 0 ) ), Set() ) )
