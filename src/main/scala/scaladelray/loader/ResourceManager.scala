...
object ResourceManager {
   ...
   * @param fastLoad Flag to perform faster loading, typically by not eliminating duplicated vertices.
   */
  def preLoad( fileName : String, subDivideDecider : ((Int,Int) => Boolean ), fastLoad : Boolean ) {
   ...
   */
  def load( fileName : String, subDivideDecider : ((Int,Int) => Boolean ), fastLoad : Boolean ) : Either[Geometry,UnknownResourceFormat] = {
