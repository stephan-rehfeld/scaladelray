...
/**
  ...
  */
case class PerspectiveCamera(e : Point3, g : Direction3, t : Direction3, imagePlaneFormat : (Double,Double), focalLength : Double, fNumber : Double, depthOfField : Double ) extends Camera( e, g, t ) {
