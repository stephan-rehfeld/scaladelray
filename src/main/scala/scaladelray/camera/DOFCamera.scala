 ...
 */
case class DOFCamera ( e : Point3, g : Vector3, t : Vector3, width : Int, height : Int, a : Double, focalLength : Double, lensRadius : Double, aaSamplingPattern : SamplingPattern = SamplingPattern.regularPattern( 1, 1 ), lensSamplingPoints : SamplingPattern = SamplingPattern.regularPattern( 1, 1 ) ) extends Camera( e, g, t ) with Serializable {
